...
| `tests/test_quick_strategy_checks.py`, `tests/test_point1_point2_checks.py`, `tests/test_full_backtest_engine.py`, `tests/test_campaign_strategy.py`, `tests/test_expiry_holidays.py`, `tests/test_data_cache.py`, `tests/test_data_layer_base.py`, `tests/test_data_layer_scenario.py`, `tests/test_position_store.py`, `tests/test_env_loader.py`, `tests/test_data_sources_env.py`, `tests/test_kite_login_url.py`, `tests/test_time_grid.py`, `tests/test_replay_feed.py`, `tests/test_live_engine.py`, `tests/test_market_data_and_expiry_detection.py`, `tests/test_scenarios.py` | Full test suite (139 tests with the optional `live` extra installed; 138 without it — one test skips cleanly rather than requiring `kiteconnect`) for the pieces described in this document |
